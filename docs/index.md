...
* **✅ CI Ready**: Built-in `check` command with semantic comparison logic. Supports native annotations for **GitHub Actions**, **GitLab Code Quality** reports, and **SARIF** via the `--format` flag.
